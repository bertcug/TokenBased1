...
public class Bloomfilter {
	...
	public static void main(String[] args) throws Exception {
		Bloomfilter bloomfilter = new Bloomfilter(3000, 1000, 8);
		int i = 0;
		int j = 0;
		// System.out.println("Bloom Filter Initialize ... ");
		bloomfilter.init("E:\\a\\input.txt");
		...
		BufferedReader reader = new BufferedReader(new FileReader("E:\\a\\test.txt"));
		String line = reader.readLine();
		System.out.println(line);
		// if(bloomfilter.contains("long i,param_len,n,alg_k,alg_a;evp_pkey
		// *pkey=null;const evp_md *md = null;"))
		...
		// System.out.println("Parse 9900000 items, Time : " + (t2 - t1) + "ms ,
		// find "
